...
<body class="bg-white text-gray-900 min-h-screen flex flex-col">
    ...
    <main class="flex-1 w-full bg-white">
        <section class="max-w-4xl mx-auto py-16 px-4 md:px-8">
            <h1 class="text-3xl md:text-4xl font-extrabold text-blue-900 mb-8 text-center">Checkout</h1>
            @auth
            <div class="grid md:grid-cols-2 gap-10">
                <!-- Order Summary -->
                <div>
                    <h2 class="text-xl font-bold text-blue-900 mb-4">Order Summary</h2>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-gray-100">
                                    <td class="py-4 px-4 flex items-center gap-4">
                                        <img src="https://www.gundamplanet.com/media/catalog/product/cache/1/image/600x/9df78eab33525d08d6e5fb8d27136e95/g/p/gp-4573102616072_1.jpg" alt="RX-78-2 Gundam" class="w-12 h-12 rounded bg-white border">
                                        <div>
                    ...
                    <div class="text-lg font-semibold text-blue-900 flex justify-between items-center">
                        <span>Total:</span>
                        <span class="text-red-600">$22.99</span>
                    </div>
                </div>
                <!-- Checkout Form -->
                <div>
                    <h2 class="text-xl font-bold text-blue-900 mb-4">Shipping & Payment</h2>
                    <form class="flex flex-col gap-4">
                        <div>
                            <label for="address" class="block text-sm font-medium text-blue-900 mb-1">Shipping Address</label>
                            <input type="text" id="address" name="address" class="w-full px-4 py-2 rounded border border-gray-200 focus:ring-2 focus:ring-blue-300 focus:outline-none text-base" placeholder="123 Gunpla St." required />
                        </div>
                        <div class="flex gap-4">
                            <div class="flex-1">
                                <label for="city" class="block text-sm font-medium text-blue-900 mb-1">City</label>
                                <input type="text" id="city" name="city" class="w-full px-4 py-2 rounded border border-gray-200 focus:ring-2 focus:ring-blue-300 focus:outline-none text-base" placeholder="City" required />
                            </div>
                            <div class="flex-1">
                                <label for="postal" class="block text-sm font-medium text-blue-900 mb-1">Postal Code</label>
                                <input type="text" id="postal" name="postal" class="w-full px-4 py-2 rounded border border-gray-200 focus:ring-2 focus:ring-blue-300 focus:outline-none text-base" placeholder="12345" required />
                            </div>
                        </div>
                        <div>
                            <label for="country" class="block text-sm font-medium text-blue-900 mb-1">Country</label>
                            <input type="text" id="country" name="country" class="w-full px-4 py-2 rounded border border-gray-200 focus:ring-2 focus:ring-blue-300 focus:outline-none text-base" placeholder="Country" required />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-blue-900 mb-1">Payment Method</label>
                            <select class="w-full px-4 py-2 rounded border border-gray-200 focus:ring-2 focus:ring-blue-300 focus:outline-none text-base">
                                <option>Credit Card</option>
                                <option>PayPal</option>
                                <option>Bank Transfer</option>
                            </select>
                        </div>
                        <button type="submit" class="bg-yellow-400 text-blue-900 px-8 py-3 rounded font-bold text-lg hover:bg-yellow-300 transition mt-4">Place Order</button>
                    </form>
                </div>
            </div>
            @else
            <div class="text-center text-gray-500 py-20">
                ...
                <p class="text-lg">Please log in to proceed to checkout.</p>
